...
{
    class RTFPALogProgram
    {
        static string inputfilename;
        public static string type = String.Empty;
        public static bool debug = false;
        public static string version = "0.99_log";
        //static string outputfilename = "fmhi_data_" + version + ".sqlite";
        static string outputfilename = "fractal_tracker.sqlite";
        ...
        static void Main(string[] args)
        {
            ...
            {
                System.Console.WriteLine("You must specify a valid input file path using the -log parameter!");
                Environment.Exit(0);
            }
        ...
        static void ProcessArgs(string[] args)
        {
            ...
            for(int i=0;i<args.Length;i++){
                switch (args[i].ToLower())
                {
                    ...
                    case "?":
                    case "-?":
                        System.Console.WriteLine("Usage FractalTracker <-option> <-option> ...\n");
